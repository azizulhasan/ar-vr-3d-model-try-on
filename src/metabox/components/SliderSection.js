              ...
              >
                ...
                <div className="art-flex art-items-center art-gap-2">
                  <button
                    ...
                    title="Duplicate"
                  >
                    <span className="dashicons dashicons-admin-page art-text-gray-700"></span>
                  </button>
                  {items.length > 1 && (
                    <button
                      type="button"
                      ...
                      className="art-p-1 hover:art-bg-red-100 art-rounded art-transition-colors"
                      title="Delete"
                    >
                      <span className="dashicons dashicons-no-alt art-text-red-600"></span>
                    </button>
                  )}
                </div>
              </div>
              ...
              {item.isExpanded && (
                <div className="art-p-4">
                  ...
                  <label className="art-text-xs art-font-semibold art-uppercase art-flex art-items-center art-gap-1">
                    MODEL {basicSettings.src === "upload" ? "File" : "URL"} FOR
                    ANDROID
                  </label>
                  ...
                  <label className="art-text-xs art-font-semibold art-uppercase art-flex art-items-center art-gap-1 art-mt-4">
                    MODEL {basicSettings.ios_src === "upload" ? "File" : "URL"}{" "}
                    FOR IOS
                  </label>
                  <div className="art-flex art-mt-1 art-border art-rounded art-overflow-hidden">
                    <button
                  ...
                  <div className="art-flex art-mt-1 art-border art-rounded art-overflow-hidden">
                    <button
                      type="button"
                      onClick={() => handleMediaButtonClick("poster", "upload")}
                      className={`art-p-2 art-transition-all art-duration-200 ${
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setBasicSettings((prev) => ({ ...prev, poster: "url" }))
                      }
                      className={`art-p-2 art-transition-all art-duration-200 ${
                  ...
                  <p className="art-text-sm art-text-gray-600 art-mt-2">
                    Insert a text. If the text field is left empty, the name of
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleItemChange(item.id, "skybox_image", e.target.value)
                    }
                    className="art-w-full art-mt-1 art-p-2 art-border art-rounded"
