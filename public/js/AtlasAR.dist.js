...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CTANotice: () => (/* binding */ CTANotice),
...
/* harmony export */   findWatchedPropertyChanges: () => (/* binding */ findWatchedPropertyChanges),
...
/* harmony export */   is_premium_active: () => (/* binding */ is_premium_active),
...
/* harmony export */ });
/* harmony import */ var _Notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Notify */ "./src/context/Notify.js");
...
var setModelAttributes = function setModelAttributes(modelViewer, model_settings) {
  var _model_settings$shado, _model_settings$dimen3, _model_settings$multi;
  console.log({
  ...
  // Dimension
  if (model_settings !== null && model_settings !== void 0 && (_model_settings$dimen3 = model_settings.dimensions) !== null && _model_settings$dimen3 !== void 0 && _model_settings$dimen3.show) {
...
var CTANotice = function CTANotice() {
  ...
  (0,_Notify__WEBPACK_IMPORTED_MODULE_0__.toast)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
...
var is_premium_active = function is_premium_active() {
  var _ar_try_on, _ar_try_on2, _Object$values, _ar_try_on3;
  var should_save_data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var result = true;
  if (!((_ar_try_on = ar_try_on) !== null && _ar_try_on !== void 0 && (_ar_try_on = _ar_try_on.plugins) !== null && _ar_try_on !== void 0 && _ar_try_on.includes(ar_try_on.premium_file))) {
    result = false;
  }
  if ((_ar_try_on2 = ar_try_on) !== null && _ar_try_on2 !== void 0 && _ar_try_on2.active_plugins && !((_Object$values = Object.values(ar_try_on.active_plugins)) !== null && _Object$values !== void 0 && _Object$values.includes(ar_try_on.premium_file))) {
    result = false;
  }
  if (!((_ar_try_on3 = ar_try_on) !== null && _ar_try_on3 !== void 0 && _ar_try_on3.is_pro_active)) {
    result = false;
  }
...
var findWatchedPropertyChanges = function findWatchedPropertyChanges(prev, next) {
  var watchedKeys = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ['hotspots', "multipleItems", "dimensions", "isMultiple"];
  var changes = [];
  function walk(prevNode, nextNode) {
    var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
    var isObjPrev = prevNode && _typeof(prevNode) === "object";
    var isObjNext = nextNode && _typeof(nextNode) === "object";
    if (!isObjPrev && !isObjNext) return;

    // 1) Check watched keys at this level
    var _iterator = _createForOfIteratorHelper(watchedKeys),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var key = _step.value;
        var prevHas = isObjPrev && Object.prototype.hasOwnProperty.call(prevNode, key);
        var nextHas = isObjNext && Object.prototype.hasOwnProperty.call(nextNode, key);
        if (prevHas || nextHas) {
          var prevVal = prevHas ? prevNode[key] : undefined;
          var nextVal = nextHas ? nextNode[key] : undefined;
          if (_isDifferent(prevVal, nextVal)) {
            changes.push({
              key: key,
    ...
    var keys = new Set([].concat(_toConsumableArray(isObjPrev ? Object.keys(prevNode) : []), _toConsumableArray(isObjNext ? Object.keys(nextNode) : [])));
    var _iterator2 = _createForOfIteratorHelper(keys),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var _key = _step2.value;
        var childPath = path ? "".concat(path, ".").concat(_key) : _key;
        walk(isObjPrev ? prevNode[_key] : undefined, isObjNext ? nextNode[_key] : undefined, childPath);
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  return {
    ...
    changes: changes // array of all found differences
  };
};
