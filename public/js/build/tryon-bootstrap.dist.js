...
/******/ 			if ({"tryon-controller":1,"tryon-face-worker":1}[chunkId]) return "public/js/build/chunks/" + chunkId + ".js";
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "ar-try-on:";
...
/******/ 		var installedChunks = {
/******/ 			"/public/js/build/tryon-bootstrap.dist": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkar_try_on"] = self["webpackChunkar_try_on"] || [];
...
(function () {
  ...
  if (typeof window !== 'undefined' && window.atlas_ar_tryon && window.atlas_ar_tryon.plugin_url) {
    ...
    __webpack_require__.p = window.atlas_ar_tryon.plugin_url;
  }
  var cfg = typeof window !== 'undefined' && window.atlas_ar_tryon || {};
  var TRY_ON_LABEL = cfg.button_label || 'Try it on';
  ...
  function rewriteLabel(btn) {
    ...
    var trimmed = (btn.textContent || '').trim();
  ...
  function rewriteAllLabels() {
    document.querySelectorAll('.ar_vr_3d_model_try_on').forEach(function (btn) {
  ...
  function _handleClick() {
    _handleClick = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(evt) {
      var btn, productId, mode, glbSrc, mod;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            btn = evt.target.closest('.ar_vr_3d_model_try_on');
            if (!(!btn || !isTryOnButton(btn))) {
              _context.next = 3;
              break;
            }
          ...
          case 3:
            ...
            return _context.abrupt("return");
          case 7:
            productId = btn.getAttribute('product-id') || btn.dataset.productId || '0';
            mode = btn.dataset.mode || 'face-glasses';
            glbSrc = btn.dataset.glbSrc || '';
            btn.disabled = true;
            btn.dataset.loading = '1';
            _context.prev = 12;
            _context.next = 15;
            return __webpack_require__.e(/*! import() | tryon-controller */ "tryon-controller").then(__webpack_require__.bind(__webpack_require__, /*! ./tryon-controller.js */ "./public/js/tryon/tryon-controller.js"));
          case 15:
            mod = _context.sent;
            _context.next = 18;
            return mod.startTryOn({
              productId: productId,
              mode: mode,
              glbSrc: glbSrc,
              config: cfg,
          ...
          case 21:
            ...
            console.error('[AtlasAR] Try-On failed to start:', _context.t0);
            activeSession = null;
          case 25:
            _context.prev = 25;
            btn.disabled = false;
      ...
      }, _callee, null, [[12, 21, 25, 29]]);
    }));
    return _handleClick.apply(this, arguments);
  }
  document.addEventListener('click', handleClick, true);
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', rewriteAllLabels, {
      once: true
    });
  } else {
    rewriteAllLabels();
