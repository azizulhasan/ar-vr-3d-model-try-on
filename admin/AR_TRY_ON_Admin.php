...
class AR_TRY_ON_Admin {
	...
	public function enqueue_styles() {
		if ( AR_TRY_ON_Helper::is_ar_try_on_for_wordpress_page() || AR_TRY_ON_Helper::is_product_page() ) {
			wp_enqueue_style( 'ar-try-on-for-wordpress', plugin_dir_url( dirname( __FILE__ ) ) . 'public/css/ar-try-on.css', array(), $this->version, 'all' );
		}
	}
...
//		}
	...
	public function ar_try_on_menu() {
		add_menu_page(
			...
			plugins_url('ar-try-on-for-wordpress') . '/admin/images/ar-try-on-logo-resized-30x34.png',
			20
		);
	}
