...
/*!*********************************************!*\
  ...
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_context_Notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/context/Notify */ "./src/context/Notify.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (ar_try_on && ar_try_on.is_pro_active) {
    allowedFileTypes = _objectSpread(_objectSpread({}, allowedFileTypes), {}, {
      obj: "model/obj",
  ...
  function isAllowedFileTypes(attachment) {
    var mimeType = attachment.mime; // or file.mime_type depending on version
  ...
  function uploadModelFile(fieldName) {
    ...
    var isModelField = fieldName === 'src' || fieldName === 'ios_src' || fieldName.startsWith('variant_');

    // Get allowed mime types for library filter
    var allowedMimeTypes = Object.values(allowedFileTypes);
    ...
    mediaUploader.on('select', function () {
      ...
      if (!isAllowedFileTypes(attachment) && (fieldName === 'src' || fieldName === 'ios_src')) {
        alert("This file format is not allowed. Please try to upload one of these files. ".concat(Object.keys(allowedFileTypes).join(', ')));
        return;
      }
      if (field) {
      ...
      var actionName = 'atlas_ar_on_select_model_file';
      if (isMultiple) {
  ...
  wp.hooks.addAction('atlas_ar_select_light_and_envirement_files', 'ar_try_on', function (_ref) {
    var name = _ref.name,
      field = _ref.field,
