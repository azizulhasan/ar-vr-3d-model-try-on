...
var product_id = (0,_src_context_utilities__WEBPACK_IMPORTED_MODULE_0__.getPostID)();
console.log({
...
if (false) { var formData, loadingMessage, htmlContent; } else if (product_id) {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          if (document.getElementById('atlas_ar_preview')) {
            document.getElementById('atlas_ar_preview').innerHTML = _htmlContent;
  ...
  wp.hooks.addAction('atlas_ar_preview_data', 'ar_try_on', function (data) {
    model_settings = _objectSpread(_objectSpread({}, model_settings), data);
    // Check if the data exists before assigning it to model-viewer
    if (model_settings) {
      var modelViewer = document.querySelectorAll('.atlas_ar_model_viewer')[0];
      if (modelViewer) {
        (0,_src_context_utilities__WEBPACK_IMPORTED_MODULE_0__.setModelAttributes)(modelViewer, model_settings);
      }
    }
  });
}
