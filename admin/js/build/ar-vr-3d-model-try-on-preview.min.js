...
var product_id = (0,_src_context_utilities__WEBPACK_IMPORTED_MODULE_1__.getPostID)();
console.log({
...
if (false) { var formData, loadingMessage, htmlContent; } else {
  var _htmlContent = "\n                        <div style=\"display: flex; justify-content: center; align-items: center; height: 100%;\">\n                            <model-viewer \n                                id=\"model-viewer\" \n                                src=\"\" \n                                alt=\"\" \n                                poster=\"\" \n                                reveal=\"\" \n                                loading=\"\" \n                                ar \n                                ar-modes=\"\" \n                                camera-controls\n                                ar-scale=\"auto\"\n                                xr-environment\n                                style=\"width: 100%; max-width: 600px; height: 400px;\"\n                            ></model-viewer>\n                        </div>";
  var _formData = new FormData();
  _formData.append('product_id', product_id);
  var model_settings = {};
  await (0,_src_context_utilities__WEBPACK_IMPORTED_MODULE_1__.postWithoutImage)((0,_src_context_utilities__WEBPACK_IMPORTED_MODULE_1__.getURL)('get_model_and_settings'), _formData).then(function (response) {
    if (response.success) {
      model_settings = response.data;
      document.getElementById('ar_try_on_preveiw').innerHTML = _htmlContent;
    } else {
  ...
  wp.hooks.addAction('ar_try_on_preview_data', 'ar_try_on', function (data) {
    ...
    if (data.ar_try_on_ar_placement === 'floor' || data.ar_try_on_ar_placement === 'wall') {
      ...
      document.getElementById('ar_try_on_preveiw').innerHTML = _htmlContent2;
      ...
      if (data) {
        ...
        wp.hooks.doAction('ar_try_on_pro_load_face_model', _htmlContent2, model_settings);
      }
    }
  });
}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./admin/js/ar-vr-3d-model-try-on-preview.js");
/******/ 	
/******/ })()
;